def move2(players, loot):
    """
    Spieler 2 bleibt stehen und gibt seine aktuellen Koordinaten zurück.
    ...
    """
    # players[1] entspricht den Koordinaten von Spieler2
    return tuple(players[1])
